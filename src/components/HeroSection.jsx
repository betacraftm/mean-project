...
export default function HeroSection({
  ...
  return (
    <div className="bg-[url('/hero-image.png')] bg-cover bg-center bg-no-repeat">
      <div className="mx-auto flex min-h-96 flex-col justify-between px-3 py-7 min-[425px]:min-h-screen sm:justify-between md:max-w-2xl md:px-0 lg:max-w-4xl xl:max-w-6xl 2xl:max-w-7xl">
