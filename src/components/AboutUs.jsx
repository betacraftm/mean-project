    ...
    >
      <div className="flex justify-between">
        ...
        <div className="mt-7 w-28 sm:w-36 md:w-52 lg:w-64 xl:w-80 2xl:flex 2xl:w-fit">
          <Image src="master-bedroom.png" className="object-cover" />
      ...
      <div className="relative scroll-mt-10">
        <p
          id="about-us-slogan"
          className="mt-5 font-beautique text-base font-medium italic leading-3 text-[#193F53] sm:mt-10 sm:w-3/5 sm:text-lg sm:leading-[15px] lg:text-2xl xl:text-3xl xl:leading-[18px] 2xl:ml-12 2xl:mt-24 2xl:text-4xl 2xl:leading-8"
        >
