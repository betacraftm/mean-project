    ...
    <>
      ...
      >
        ...
        <div className="mt-3 flex justify-center sm:mt-6 xl:mt-10">
          ...
          <div className="flex w-[95px] flex-col items-center justify-center border-l border-r border-[#193F53] min-[375px]:w-[120px] sm:w-[180px] md:w-[200px] lg:w-[270px] xl:w-[400px] xl:border-l-4 xl:border-r-4">
            <img
              src="deck.png"
